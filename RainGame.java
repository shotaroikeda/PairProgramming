//UIUC CS125 FALL 2014 MP. File: RainGame.java, CS125 Project: PairProgramming, Version: 2015-02-23T22:23:14-0600.443184943
/**
...
public class RainGame {
	...
	public static void main(String[] args) {
		...
		while (Zen.isRunning()) {
			...
			if (level >= 20 && level < 30)Zen.setColor(0, 250, 0); // Color at level 20 goes to WHITE
			...
			Zen.flipBuffer(); // stops the flicker
